	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			while (fileItemsIterator.hasNext()) {
				...
				runMCDA(dataMatrix, options);
				
				
			}
		} catch (FileUploadException e) {
			out.write("<b>Exception in uploading file.</b>");
			out.write(e.toString());
		} catch (Exception e) {
			out.write("<b>Exception: </b>");
			out.write(e.toString());
		}
		out.write("</body></html>");
	}

	private void runMCDA(DataMatrix dataMatrix, String options) throws Exception {
		
		//http://localhost:port_number/quiz2/wsm
		//call Topsis, call WSM
		//They return JSON string
		//Use JSON String
